      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0a261a]/80 backdrop-blur-xl border-b border-white/5 px-8 py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button 
            ...
            className="text-[#8fa69a] hover:text-white font-bold text-[11px] uppercase tracking-[2px]"
          >
            Login
          </Button>
          <button 
      ...
      <section className="relative pt-52 pb-40 px-8 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button 
              onClick={() => navigate('/signup')}
              className="h-16 px-12 bg-[#6d8c7c] text-[#0a261a] rounded-3xl font-black text-xs uppercase tracking-[3px] hover:bg-white transition-all shadow-2xl shadow-[#6d8c7c]/20 flex items-center justify-center gap-3"
            >
